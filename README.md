...
2. По аналогии с программами из примеров самомтоятельно написать программу на языках C++ и Python, получающую доступный объём оперативной памяти с помощью функции GetPhysicallyInstalledSystemMemory.
